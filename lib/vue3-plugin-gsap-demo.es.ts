import { defineComponent, getCurrentInstance, ref, onMounted, openBlock, createElementBlock, toDisplayString, unref } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let showNumber = ref(props.startNumber);
    onMounted(() => {
...
export { _sfc_main as GsapNumber, index as default };
